...
**Estado:** ✅ RESUELTO (2026-09-11, opción a) — solo PREVIEW, sin desplegar. `resolve_label` ahora, cuando el grupo de mejores empates son ≥3 nodos distintos con un ÚNICO padre común, resuelve al PADRE (constante `_GENERIC_PARENT_MIN_TIES=3`). "software" → S02 "Tecnología" (859 empresas). Umbral ≥3 preserva la precisión de empates de 2 sinónimos (p.ej. "farmaceutico" → "Industria farmacéutica", NO salta a S05). Verificado unit + tests 3/3 + E2E preview. Detalle en CHANGELOG 2026-09-11.
